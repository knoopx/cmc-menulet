...
module.exports = (name, entries = [], targets = [], overrides) => merge(
  {
    entry: {
      [name]: [
        ...
        },
        {
          ...
          use: [
            ...
            },
            {
              ...
              options: {
                whitelist: ['html', 'body', ...whitelister(path.resolve('node_modules/cryptocoins-icons/webfont/cryptocoins.css'))],
                content: [
